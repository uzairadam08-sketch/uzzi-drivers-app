// One-off: add drivers Amanjot Sandhu (#13) and Prabhjot Singh (#14).
// Safe to re-run: existing users are found and updated, not duplicated.
//   node scripts/add-amanjot-prabhjot.mjs
...
const DRIVERS = [
  {
    number: 13,
    email: "amanjot@milescraft.uk",
    password: "Amanjot@Sandhu13",
    name: "Amanjot Sandhu",
  },
  {
    number: 14,
    email: "prabhjot@milescraft.uk",
    password: "Prabhjot@Singh14",
    name: "Prabhjot Singh",
  },
];
