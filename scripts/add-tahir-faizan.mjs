// One-off: add drivers Tahir (#16) and Faizan (#17).
// Safe to re-run: existing users are found and updated, not duplicated.
//   node scripts/add-tahir-faizan.mjs
...
const DRIVERS = [
  {
    number: 16,
    email: "tahir@milescraft.uk",
    password: "Tahir@Driver16",
    name: "Tahir",
  },
  {
    number: 17,
    email: "faizan@milescraft.uk",
    password: "Faizan@Driver17",
    name: "Faizan",
  },
];
