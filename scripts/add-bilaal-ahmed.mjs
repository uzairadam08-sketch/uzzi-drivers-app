// One-off: add drivers Bilaal (#18) and Ahmed Fahad (#19).
// Safe to re-run: existing users are found and updated, not duplicated.
//   node scripts/add-bilaal-ahmed.mjs
...
const DRIVERS = [
  {
    number: 18,
    email: "bilaal@milescraft.uk",
    password: "Bilaal@Driver18",
    name: "Bilaal",
  },
  {
    number: 19,
    email: "ahmed@milescraft.uk",
    password: "Ahmed@Fahad19",
    name: "Ahmed Fahad",
  },
];
